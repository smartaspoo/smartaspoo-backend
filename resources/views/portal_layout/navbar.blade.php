                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="navbar-menu nav-link dropdown-toggle"
                            style="font-size: 16px; align:center; font-weight: bold;" href="#"
                            id="kategoriDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-width"
                            ...
                            <div class="bottom-dropdown">
                                ...
                                <a style="margin-left: 80px;" class="dropdown-item"
                                    href="{{ url('/p/logout') }}">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>

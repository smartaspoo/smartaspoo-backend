                        ...
                        <table class="table">
                            ...
                            <tbody id="bodyTable">
                                ...
                                foreach ($dataPenjualan as $row) : ?>
                                    <?php if (intval($row['penjualan_child_satuan_rubah_id']) == 0 || intval($row['penjualan_child_satuan_rubah_jumlah']) == 0) : ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td><?= $row['obat_nama'] ?></td>
                                    ...
                                    <?php else : ?>
                                        <?php $satuan_nama = getData("SELECT * FROM satuan WHERE satuan_id = '$row[penjualan_child_satuan_rubah_id]'")[0]['satuan_nama'] ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td><?= $row['obat_nama'] ?></td>
                                            <td><?= $satuan_nama . " | (" . $row['satuan_nama'] . ")" ?></td>
                                            <td><?= $row['penjualan_child_satuan_rubah_jumlah'] . " | (" . $row['penjualan_child_jumlah']  . ")" ?></td>
                                            <td><?= $row['obat_harga_jual'] ?></td>
                                            <td><?= $row['penjualan_child_subtotal'] ?></td>
                                        </tr>
                                    <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <select disabled class="form-control selectpicker" data-style="btn btn-link" name="pelanggan" id="pelanggan">

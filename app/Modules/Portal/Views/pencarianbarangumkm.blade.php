...
<body>
    <div class="container custom-margin"> 
        <ul class="nav nav-underline">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" style="font-size: 28px;"><i class="bi bi-shop-window" ></i>&nbsp; UMKM</a>
            </li>
            <li class="nav-item">
                <a class="nav-link disabled" aria-disabled="true" style="font-size: 28px;">TOKO</a>
            </li>
        </ul>
    </div>
    <br>

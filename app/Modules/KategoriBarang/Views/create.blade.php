...
<div class="page-inner">
    <div id="add-kategori-barang" class="card">
    ...
    Vue.createApp({
        ...
        methods: {
            ...
            resetForm(){
                ...
                this.$refs.kategori_barang_form.reset()
            },
            async store() {
                try {
                    showLoading()
                    const response = await httpClient.post("{!! url('kategori-barang') !!}", this.kategori_barang)
                    hideLoading()
                    showToast({

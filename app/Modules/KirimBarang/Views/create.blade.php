...
<div class="page-inner">
    <div id="add-kirim-barang" class="card">
    ...
    Vue.createApp({
        ...
        methods: {
            ...
            resetForm(){
                ...
                this.$refs.kirim_barang_form.reset()
            },
            async store() {
                try {
                    showLoading()
                    const response = await httpClient.post("{!! url('kirim-barang') !!}", this.kirim_barang)
                    hideLoading()
                    showToast({

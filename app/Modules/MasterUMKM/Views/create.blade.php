...
<div class="page-inner">
    <div id="add-masterumkm" class="card">
    ...
    Vue.createApp({
        ...
        methods: {
            ...
            resetForm(){
                ...
                this.$refs.masterumkm_form.reset()
            },
            async store() {
                try {
                    showLoading()
                    const response = await httpClient.post("{!! url('masterumkm') !!}", this.masterumkm)
                    hideLoading()
                    showToast({

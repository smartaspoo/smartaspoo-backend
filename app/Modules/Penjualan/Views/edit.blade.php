...
<div class="page-inner">
    <div id="edit-penjualan" class="card">
...
<script>
    Vue.createApp({
        ...
        methods: {
            async fetchData() {
                const response = await httpClient.get("{!! url('penjualan') !!}/{{ $penjualan_id }}")
                this.penjualan = response.data.result
            ...
            async update() {
                try {
                    showLoading()
                    const response = await httpClient.put("{!! url('penjualan') !!}/{{ $penjualan_id }}",
                        this.penjualan)
                    hideLoading()
                    showToast({

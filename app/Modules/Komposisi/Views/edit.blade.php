...
<div class="page-inner">
    <div id="edit-komposisi" class="card">
...
<script>
    Vue.createApp({
        ...
        methods: {
            async fetchData() {
                const response = await httpClient.get("{!! url('komposisi') !!}/{{ $komposisi_id }}")
                this.komposisi = response.data.result
            ...
            async update() {
                try {
                    showLoading()
                    const response = await httpClient.put("{!! url('komposisi') !!}/{{ $komposisi_id }}",
                        this.komposisi)
                    hideLoading()
                    showToast({

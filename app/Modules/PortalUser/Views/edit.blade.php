...
<div class="page-inner">
    <div id="edit-portaluser" class="card">
...
<script>
    Vue.createApp({
        ...
        methods: {
            async fetchData() {
                const response = await httpClient.get("{!! url('portaluser') !!}/{{ $portaluser_id }}")
                this.portaluser = response.data.result
            ...
            async update() {
                try {
                    showLoading()
                    const response = await httpClient.put("{!! url('portaluser') !!}/{{ $portaluser_id }}",
                        this.portaluser)
                    hideLoading()
                    showToast({
